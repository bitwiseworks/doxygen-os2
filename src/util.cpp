...
#if defined(_WIN32) || defined(__MACOSX__) || defined(__CYGWIN__) || defined(__OS2__) // Windows or MacOSX
...
#if defined(_WIN32) || defined(__MACOSX__) || defined(__CYGWIN__) || defined(__OS2__)
